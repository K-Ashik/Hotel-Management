...
<div class="banner-top">
			...
			<!-- <div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@ASHIK.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+92-***-*******</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">ASHIK'S <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">ASHIK'S HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree" style="padding-top:3%;">Our Gallery</h3>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com" class="link">Khalid.ashik@yahoo.com</a></p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2018 ASHIK'S HOTEL . All Rights Reserved | Design by <a href="index.php">Khalid Ashik</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
...
<!-- live chat testing for customer support -->
...
$.src="https://v2.zopim.com/?5UAwrWoLGHQ70lDE7fO9Bf2Cbcr339mb";z.t=+new Date;$.
