...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<span><img alt="" src="assets/img/hotel.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
				<p><?php echo $fname." " ?> <br></p>
			</address>
			<table class="meta">
				<tr>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- khalid.ashik@yahoo.com || Web :- www.ashik's-hotel.com || Phone :- +880234589 </p>
			</div>
		</aside>
	</body>
</html>
