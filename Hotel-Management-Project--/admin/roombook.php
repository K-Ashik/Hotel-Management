        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
					...
					<?php
						if(isset($_SESSION["roombook"])){
							echo $_SESSION["roombook"];
							session_destroy();
						}
					?>
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														$psql = "INSERT INTO `payment`(`id`, `fname`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`meal`, `mepr`, `btot`,`fintot`,`noofdays`) VALUES ('$id','$fname','$troom','$bed','$nroom','$cin','$cout','$ttot','$meal','$mepr','$btot','$fintot','$days')";
